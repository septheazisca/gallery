...
<body>
  ...
  <div class="container py-5 border-bottom">
    <div class="category-section">
      ...
      <button class="btn btn-kategori py-2 px-4 mb-2 me-1">halo</button>
      <button class="btn btn-kategori py-2 px-4 mb-2 me-1">halo</button>
      <button class="btn btn-kategori py-2 px-4 mb-2 me-1">akka</button>
      <button class="btn btn-kategori py-2 px-4 mb-2 me-1">halo</button>
      <button class="btn btn-kategori py-2 px-4 mb-2 me-1">halo</button>
      <button class="btn btn-kategori py-2 px-4 mb-2 me-1">halo</button>
      <button class="btn btn-kategori py-2 px-4 mb-2 me-1">halo</button>
      <button class="btn btn-kategori py-2 px-4 mb-2 me-1">halo</button>
      <button class="btn btn-kategori py-2 px-4 mb-2 me-1">halo</button>
      <button class="btn btn-kategori py-2 px-4 mb-2 me-1">asasassaaasa</button>
      <button class="btn btn-kategori py-2 px-4 mb-2 me-1">halo</button>
      <button class="btn btn-kategori py-2 px-4 mb-2 me-1">halo</button>
      <button class="btn btn-kategori py-2 px-4 mb-2 me-1">halo</button>
      <button class="btn btn-kategori py-2 px-4 mb-2 me-1">halo</button>
